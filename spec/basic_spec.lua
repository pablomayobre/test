describe("Plutfo and UTF-8 Lua Library unit testing framework", function ()
	...
	describe("utf8.offset", function ()
		...
		it("Position out of range", function ()
			assert.error_matches(wcall(utf.offset, "abc", 1,  5), "position out of range", nil, true)
			assert.error_matches(wcall(utf.offset, "abc", 1, -4), "position out of range", nil, true)
			assert.error_matches(wcall(utf.offset, "",	 1,  2),  "position out of range", nil, true)
